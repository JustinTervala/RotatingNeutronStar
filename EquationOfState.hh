...
class EquationOfState {
    ...
    public:
        ...
        double e_at_p(double pp, int& n_nearest_pt);         
        double p_at_e(double ee, int& n_nearest_pt);        
        double p_at_h(double hh, int& n_nearest_pt);
        double h_at_p(double pp, int& n_nearest_pt);
        double n0_at_e(double ee, int& n_nearest_pt);
